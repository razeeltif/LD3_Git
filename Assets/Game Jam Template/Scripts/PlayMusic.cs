...
public class PlayMusic : MonoBehaviour {
    ...
    public AudioClip hurt1Music;
    public AudioClip hurt2Music;
    public AudioClip hurt3Music;
    ...
    public void PlaySelectedMusic(int musicChoice) {
        ...
        switch (musicChoice) {
            ...
            case 2:
                musicSource.clip = hurt1Music;
                break;

            case 3:
                musicSource.clip = hurt2Music;
                break;
            case 4:
                musicSource.clip = hurt3Music;
                break;
        }
